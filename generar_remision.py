...
def build_remision_story(data, sello_path=None):
    S = {
        ...
        'th' : ps('th',  font='Helvetica-Bold', size=9,  leading=11, color=BLANCO, align=TA_CENTER),
        'sh' : ps('sh',  font='Helvetica-Bold', size=6.5,leading=8,  color=BLANCO, align=TA_CENTER),
